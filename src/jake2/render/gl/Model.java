...
//	  ===============================================================================
  private static class ModelRequest {
    ...
    public ArrayList<AsyncCallback<model_t>> callbacks = new ArrayList<AsyncCallback<model_t>>();
...
//		}
	...
	==================
	*/
	void Mod_ForName(final String name, AsyncCallback<model_t> callback)
	{
    int i;
...
//    	}
        ...
        Model.this.fileBuffer = null; // free it for garbage collection
        for (AsyncCallback<model_t> callback : modelReq.callbacks) {
...
//	  =============================================================================
	...
	*/
	protected void R_BeginRegistration(String model, final Command callback)
	{
		...
		Mod_ForName(fullname, new AsyncCallback<model_t>() {
	...
	@@@@@@@@@@@@@@@@@@@@@
	*/
	protected void R_RegisterModel(String name, final AsyncCallback<model_t> callback) {
		Mod_ForName(name, new AsyncCallback<model_t>() {
      public void onSuccess(model_t mod) {
        int   i;
        qfiles.dmdl_t pheader;
