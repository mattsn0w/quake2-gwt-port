...
//            Cvar.Set("game", str);
     ...
     * ================
     */
    public static void LoadClientinfo(final clientinfo_t ci, String s) {
        int i;
        int t;
        ...
        if (Globals.cl_noskins.value != 0 || s.length() == 0) {
            ...
            // weapon file
            num_weapon_filenames = CL_view.num_cl_weaponmodels;
...
//                }
        ...
        Globals.re.RegisterModel(model_filename, new AsyncCallback<model_t>() {
    ...
    private static void loadWeaponModel(final clientinfo_t ci, final int i, String weapon_filename) {
      Globals.re.RegisterModel(weapon_filename, new AsyncCallback<model_t>() {
        public void onSuccess(model_t response) {
    ...
    public static void ParseConfigString() {
        ...
        if (i >= Defines.CS_LIGHTS
            ...
            if (Globals.cl.refresh_prepped) {
                ...
                Globals.re.RegisterModel(Globals.cl.configstrings[i], new AsyncCallback<model_t>() {
                  public void onSuccess(model_t response) {
