 ...
 * Netchan
 */
public final class NetworkChannels extends ServerMain {
    ...
    public static ConsoleVariable qport;
    ...
    public static void Netchan_Init() {
        ...
        qport = ConsoleVariables.Get("qport", "" + port, Defines.CVAR_NOSET);
    }

    private static final byte send_buf[] = new byte[Defines.MAX_MSGLEN];
    private static final Buffer send = new Buffer();
    /*
     * =============== Netchan_OutOfBand
     * 
     ...
     */
    public static void Setup(int sock, NetworkChannel chan, NetworkAddress adr, int qport) {
     ...
     */
    public static boolean Netchan_CanReliable(NetworkChannel chan) {
    ...
    // das ist richtig !!!
    public static boolean Netchan_NeedReliable(NetworkChannel chan) {
