...
public class ModelLeaf extends ModelNode {
	...
	*/
	...
	public void setMarkSurface(int markIndex, ModelSurface[] markSurfaces) {
		this.markIndex = markIndex;
		this.markSurfaces = markSurfaces;
	}

	public ModelSurface getMarkSurface(int index) {
