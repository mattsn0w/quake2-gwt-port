...
public class DynamicLights  {
	...
	*/
	...
	// stack variable
	public static final float[] v = {0, 0, 0};
	/**
	 * R_RenderDlights
	 */
	static void render()
	{
		...
		GlState.gl.glBlendFunc (Gl1Context.GL_ONE, Gl1Context.GL_ONE);

		for (int i=0 ; i<GlState.r_newrefdef.num_dlights ; i++)
		{
			DynamicLight.R_RenderDlight(GlState.r_newrefdef.dlights[i]);
		}
	...
	*/
	...
	static void push()
	{
		...
		for (int i=0 ; i<GlState.r_newrefdef.num_dlights ; i++) {
			...
			DynamicLight.R_MarkLights( l, 1<<i, GlState.r_worldmodel.nodes[0] );
		}
	}
